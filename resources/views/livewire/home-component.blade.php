        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="dream-item">
                        <h3>
                            <a href="donations.html">This project seeks to build houses for reduce their suffering
                                allow them to live</a>
                        </h3>
                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p>
    ...
    <div class="about-area pt-100 pb-70">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="{{ asset('assets/img/about/about-main1.jpg') }}" alt="About">
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="work-area pt-100 pb-70">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="work-img">
                        <img src="{{ asset('assets/img/work/work1.jpg') }}" alt="Work">
                        <img src="{{ asset('assets/img/work/work2.jpg') }}" alt="Work">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4">
                    <div class="gallery-item">
                        <a href="{{ asset('assets/img/gallery/gallery1.jpg') }}" data-lightbox="roadtrip">
                            <img src="{{ asset('assets/img/gallery/gallery1.jpg') }}" alt="Gallery">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="gallery-item">
                        <a href="{{ asset('assets/img/gallery/gallery2.jpg') }}" data-lightbox="roadtrip">
                            <img src="{{ asset('assets/img/gallery/gallery2.jpg') }}" alt="Gallery">
                            <i class="icofont-eye"></i>
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="gallery-item">
                        <a href="{{ asset('assets/img/gallery/gallery3.jpg') }}" data-lightbox="roadtrip">
                            <img src="{{ asset('assets/img/gallery/gallery3.jpg') }}" alt="Gallery">
                            <i class="icofont-eye"></i>
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="gallery-item">
                        <a href="{{ asset('assets/img/gallery/gallery4.jpg') }}" data-lightbox="roadtrip">
                            <img src="{{ asset('assets/img/gallery/gallery4.jpg') }}" alt="Gallery">
                            <i class="icofont-eye"></i>
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="gallery-item">
                        <a href="{{ asset('assets/img/gallery/gallery5.jpg') }}" data-lightbox="roadtrip">
                            <img src="{{ asset('assets/img/gallery/gallery5.jpg') }}" alt="Gallery">
                            <i class="icofont-eye"></i>
                        </a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="gallery-item">
                        <a href="{{ asset('assets/img/gallery/gallery6.jpg') }}" data-lightbox="roadtrip">
                            <img src="{{ asset('assets/img/gallery/gallery6.jpg') }}" alt="Gallery">
                            <i class="icofont-eye"></i>
                        </a>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="blog-item">
                        <div class="top">
                            <a href="blog-details.html">
                                <img src="{{ asset('assets/img/blog/blog1.jpg') }}" alt="Blog">
                            </a>
                        </div>
                        <div class="bottom">
                            <ul>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="blog-item">
                        <div class="top">
                            <a href="blog-details.html">
                                <img src="{{ asset('assets/img/blog/blog2.jpg') }}" alt="Blog">
                            </a>
                        </div>
                        <div class="bottom">
                            <ul>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="blog-item">
                        <div class="top">
                            <a href="blog-details.html">
                                <img src="{{ asset('assets/img/blog/blog3.jpg') }}" alt="Blog">
                            </a>
                        </div>
                        <div class="bottom">
                            <ul>
