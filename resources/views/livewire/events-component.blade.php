                ...
                <div class="col-lg-6">
                    <div class="event-item">
                        ...
                        <div class="inner">
                            ...
                            <h3>
                                <a href="{{ route('event.details') }}">Fundraising for MQ</a>
                            </h3>
                            <ul>
                                <li>
                ...
                <div class="col-lg-6">
                    <div class="event-item">
                        ...
                        <div class="inner">
                            ...
                            <h3>
                                <a href="{{ route('event.details') }}">Shout about it with us</a>
                            </h3>
                            <ul>
                                <li>
                                    <i class="icofont-stopwatch"></i>
                ...
                <div class="col-lg-6">
                    <div class="event-item">
                        ...
                        <div class="inner">
                            ...
                            <h3>
                                <a href="{{ route('event.details') }}">Relief giving - Providing relief</a>
                            </h3>
                            <ul>
                                <li>
                                    <i class="icofont-stopwatch"></i>
                ...
                <div class="col-lg-6">
                    <div class="event-item">
                        ...
                        <div class="inner">
                            ...
                            <h3>
                                <a href="{{ route('event.details') }}">Volunteer meetup</a>
                            </h3>
                            <ul>
                                <li>
                                    <i class="icofont-stopwatch"></i>
                ...
                <div class="col-lg-6">
                    <div class="event-item">
                        ...
                        <div class="inner">
                            ...
                            <h3>
                                <a href="{{ route('event.details') }}">Cleaning events in Greece</a>
                            </h3>
                            <ul>
                                <li>
                                    <i class="icofont-stopwatch"></i>
                ...
                <div class="col-lg-6">
                    <div class="event-item">
                        ...
                        <div class="inner">
                            ...
                            <h3>
                                <a href="{{ route('event.details') }}">Event for free clothing</a>
                            </h3>
                            <ul>
                                <li>
                                    <i class="icofont-stopwatch"></i>
