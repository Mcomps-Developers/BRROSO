                ...
                <div class="col-lg-8">
                    <div class="details-item">
                        <div class="details-img">
                            <img src="{{ asset('assets/img/event/event-details1.jpg') }}" alt="Details">
                ...
                <div class="col-lg-4">
                    <div class="widget-area">
                        ...
                        <div class="information widget-item">
                            ...
                            <ul>
                                ...
                                <li>
                                    <span>Email:</span>
                                    <a
                                        href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#a2cac7cececde2c4cbccc6cd8cc1cdcf"><span
                                            class="__cf_email__"
                                            data-cfemail="b1d9d4dddddef1d7d8dfd5de9fd2dedc">[email&#160;protected]</span></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="instagram widget-item">
                            ...
                            <div class="m-0 row">
                                <div class="p-0 col-4 col-sm-3 col-lg-4">
